...
<Center
    ...
    gap={{base: '2em', sm: '2em', md:'4em', lg: '7em'}}>
        <Flex> 
            ![The home screen.](/screenshots/go1.png_600_1043)
        </Flex> 
        <Flex
        >
            ![The home screen.](/screenshots/go2.png_600_1068)
        </Flex>
</Center>
<br/>
...
<Center
    ...
    direction={'row'}>
            <Center
            onLoad={() => console.log('loaded this')}>
                ![The home screen.](/screenshots/go3.png_600_1078)
            </Center>
            <Center>
                ![The assessment screen.](/screenshots/go4.png_600_840)
            </Center>
</Center>
<br/>
